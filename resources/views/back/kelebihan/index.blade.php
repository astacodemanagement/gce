        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="form-tambah" action="{{ route('kelebihan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <form id="form-edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="nama_kelebihan_edit">Nama Kelebihan</label>
                                <input type="text" class="form-control" id="nama_kelebihan_edit" name="nama_kelebihan" required>
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#example1').on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                method: 'GET',
                url: '{{ route("kelebihan.edit", ":id") }}'.replace(':id', id), // Memperbaiki penempatan tanda kutip
        ...
        $('#example1').on('click', '.btn-hapus', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route("kelebihan.destroy", ":id") }}'.replace(':id', id), // Memperbaiki penempatan tanda kutip
                        type: 'DELETE',
                        data: {
                            "_token": "{{ csrf_token() }}",
                        },
