        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="form-tambah" action="{{ route('layanan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <form id="form-edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_layanan_edit" name="nama_layanan" required>
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#example1').on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                method: 'GET',
                url: '{{ route("layanan.edit", ":id") }}'.replace(':id', id), // Memperbaiki penempatan tanda kutip
        ...
        $('#example1').on('click', '.btn-hapus', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route("layanan.destroy", ":id") }}'.replace(':id', id), // Memperbaiki penempatan tanda kutip
                        type: 'DELETE',
                        data: {
                            "_token": "{{ csrf_token() }}",
                        },
