    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ $profil->nama_profil }} - {{ $subtitle }}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <div class="modal-body">
                ...
                <div class="card card-primary">
                    ...
                    <form id="form-edit" action="" method="POST">
                        @method('PUT')
                        @csrf
                        <input class="id" type="hidden" id="" name="id" />
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <script>
                                    // Dapatkan elemen input tanggal
                                    const inputTanggalEdit = document.getElementById('tanggal_posting_edit');

                                    // Dapatkan tanggal hari ini dalam format YYYY-MM-DD
                                    const todayEdit = new Date().toISOString().split('T')[0];

                                    // Set nilai default input tanggal menjadi tanggal hari ini
                                    inputTanggalEdit.value = today;
                                </script>
                                <div class="col-6">
                                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#example1').on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                method: 'GET',
                url: '{{ route("berita.edit", ":id") }}'.replace(':id', id), // Memperbaiki penempatan tanda kutip
                success: function(data) {
                    ...
                    // Set isi summernote dengan data dari server
