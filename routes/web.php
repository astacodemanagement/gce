...
use App\Http\Controllers\Front\TahapController;
use App\Http\Controllers\Front\AlasanController;
use App\Http\Controllers\Front\FaqController;
use App\Http\Controllers\Front\MitraController;
use App\Http\Controllers\Front\KelebihanController;
...
Route::middleware('auth')->group(function () {
    ...
    /** MIDDLEWARE UNTUK SUPERADMIN, MANAGER, KASIR, GUDANG, FINANCE */
    Route::middleware(['auth.backoffice', 'role:superadmin|manager|kasir|gudang|finance'])->group(function () {
